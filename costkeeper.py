...
class Good(Base):
    ...
    def __init__(self, Name, Barcode, Life, Description, Type_ID, Units_ID, Alcohol, Manufacturer_ID, Brand,
                 Prod_Country_ID):
        self.Name = Name
        self.Life = Life
...
class User(Base):
    ...
    def __init__(self, User_Nickname, User_Email, User_Firstname, User_Lastname, Role_ID, Password, Token,
                 Token_Lifetime, Creation_Date):
